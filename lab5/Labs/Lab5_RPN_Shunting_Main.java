...
public class Lab5_RPN_Shunting_Main {
    ...
    static void task2(String postfixString) {
        ...
        System.out.println("= " + MyRPN_661606.computeRPN(postfixString));

    }
    private static void task4() {
        System.out.println("-----MyQueueListWarp Tester-----");
        MyQueueListWrap_661606<String> queue;
        queue = new MyQueueListWrap_661606<>();
    ...
    public static void computeInfix(String infixString) {
        String postfixString = MyShuntingYard_661606.infixToPostfix(infixString);
        double ans = MyRPN_661606.computeRPN(postfixString);
