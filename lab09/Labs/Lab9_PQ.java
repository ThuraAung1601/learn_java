...
import solutions.pack9_Heap.MyHeapSort_661606;
import solutions.pack9_Heap.MyMinHeap_661606;
import solutions.pack9_Heap.MyPriorityQueue_661606;
...
public class Lab9_PQ {
    ...
    static void task2() {
        least3 = new ArrayList<>();
        MyPriorityQueue_661606 pq = new MyPriorityQueue_661606();
        pq.enqueue(11);
        pq.enqueue(15);
        pq.enqueue(16);
        pq.enqueue(13);
    ...
    static void task3() {
        MyHeapSort_661606 heap = new MyHeapSort_661606();
        heap.insert(11);
        heap.insert(15);
        heap.insert(16);
        heap.insert(13);
